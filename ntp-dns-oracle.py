...
username = colored('User name', 'green', attrs=['bold'])
...
print('This script downloads and installs '+ntp+' and '+dns+' servers automatically.')
print('Edit the '+iplistfile+' file to provide an IP configuration.')
print('')
print('Please input the following details: ')
env.host_string = raw_input('IP address of '+dns+' server (local or remote): ')
env.user = raw_input(username+': ')
env.password = getpass.getpass(password+': ')
domain = raw_input(domainname+' for RAC public network: ')
...
with settings(hide('warnings', 'running', 'stdout', 'stderr'), warn_only=True):
    ...
    if osver == 'Linux' and lintype == 'CentOS':
        ...
        if getlbindpack == '/usr/sbin/named' and bindlpidfile == bindlpid:
            ...
            print(' Installation and configuration of DNS server is in progress ...')
            ...
            print('DNS Server installed and configured '+successfully+'.')
        ...
        if getntppack == '/usr/sbin/ntpd' and ntppid == ntppidfile:
            ...
            print(' Installation and configuration of NTP server is in progress ...')
            ...
            print('NTP Server installed and configured '+successfully+'.')
